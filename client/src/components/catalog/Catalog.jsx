...
export default function Catalog() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await request("/data/books");
        setBooks(data);
      } catch (err) {
        alert(err.message);
      }
  ...
  return (
    <div className="max-w-6xl mx-auto px-20 pt-10 pb-14 bg-white/80 rounded-xl shadow-lg">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-2 text-center underline decoration-blue-600 underline-offset-5">
        Book Catalog
      </h1>
